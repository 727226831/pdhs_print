...
public class Request {
   ...
   // public  static String URL="http://192.168.20.252:8881";
    public  static String URL="http://jwprint.vaiwan.com";
    public static Call<ResponseBody> getRequestbody(String obj,String url) {
